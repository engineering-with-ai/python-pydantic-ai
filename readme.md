...
![](https://img.shields.io/gitlab/pipeline-status/agent-framework/python-pydantic-ai?branch=main&logo=gitlab)
![](https://gitlab.com/agent-framework/python-pydantic-ai/badges/main/coverage.svg)
